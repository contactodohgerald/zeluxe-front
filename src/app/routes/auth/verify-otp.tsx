  ...
  return (
    <AuthLayout title="">
      <div className="relative flex flex-col justify-center min-h-screen py-12 overflow-hidden bg-gray-50">
        <div className="relative w-full max-w-lg px-6 pt-10 mx-auto bg-white shadow-xl rounded-2xl pb-9">
              ...
              {({ formState }) => (
                <>
                  <div className="flex flex-col space-y-16">
                    <div className="flex flex-row items-center justify-between w-full max-w-sm mx-auto">
                      {[...Array(5)].map((_, index) => (
                        <Input
                          key={index}
                          className="flex items-center justify-center w-16 h-16 text-lg text-center bg-white border border-gray-200 outline-none rounded-xl ring-blue-700 focus:bg-gray-50 focus:ring-1"
                          type="text"
                          maxLength={1}
                    ...
                    <div className="flex flex-col space-y-5">
                      <div>
                        <Button
                          ...
                          type="submit"
                          className="flex flex-row items-center justify-center w-full py-5 text-sm text-center text-white border border-none shadow-sm outline-none rounded-xl bg-success"
                        >
                          Verify Account
                        </Button>
                      </div>
