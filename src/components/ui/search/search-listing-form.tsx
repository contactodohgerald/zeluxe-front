        ...
        {({ register, formState }) => (
          <>
            <Input
              ...
              className="h-[calc(1.5rem + 0.75rem + 2px)] mt-8 block w-full rounded-[0.25rem] border border-[#ced4da] bg-white bg-clip-padding px-3 text-[1rem] font-[400] leading-[1.5] text-[#495057] outline-none focus:outline-none"
            />
            <Input
