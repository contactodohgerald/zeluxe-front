...
import { useConfirmRentalBooking } from '../../owners/api/confirm-rental-bookings';
import { useNotifications } from '@/components/ui/notifications';
import { useConfirmBookingPayment } from '../../owners/api/confirm-booking-payment';
import { useAdminRentalBooking } from '../api/get-rental-booking';
export const BookingView = ({ bookingId }: { bookingId: string }) => {
  const { addNotification } = useNotifications();
  const bookingQuery = useAdminRentalBooking({
    bookingId,
  });
